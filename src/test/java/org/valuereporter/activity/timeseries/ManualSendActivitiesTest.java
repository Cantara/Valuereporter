...
public class ManualSendActivitiesTest {
    ...
    public static void main(String[] args) {
        ...
        String username = "whydahdev";
        String password = "WriteOrReadYouDecideDude2";
        ...
        data2.put("ip", "127.0.0.4");
        observedActivities.add(new CountedActivity(name, System.currentTimeMillis(),data2));
        CommandSendActivities sendActivities = new CommandSendActivities(influxDbUri, database,username, password, observedActivities);
