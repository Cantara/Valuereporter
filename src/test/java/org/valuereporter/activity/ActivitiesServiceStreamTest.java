...
public class ActivitiesServiceStreamTest {
    ...
    public class UserSessionObservedActivity extends ObservedActivity {
        ...
        public UserSessionObservedActivity(String userid, String userSessionActivity, String applicationtokenid, long timestamp) {
            ...
            addContextInfo("userid", userid);
            addContextInfo("usersessionfunction", userSessionActivity);
            addContextInfo("applicationtokenid", applicationtokenid);
            addContextInfo("applicationid", applicationid);
        }
